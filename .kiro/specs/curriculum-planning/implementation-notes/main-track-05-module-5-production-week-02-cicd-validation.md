...
```powershell
python -m pytest curriculum/main-track/05-module-5-production/week-02-cicd --collect-only -q
python -m pytest curriculum/main-track/05-module-5-production/week-02-cicd -q
```

...
Scaffold: `curriculum/00-python-foundations/week-02-production-python/workbench.py`

## Commands

```powershell
python -m pytest curriculum/00-python-foundations/week-02-production-python --collect-only -q
python -m pytest curriculum/00-python-foundations/week-02-production-python -q
```

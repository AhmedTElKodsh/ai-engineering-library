...
Scaffold: `curriculum/04-module-4-agentic-workflows/week-02-advanced-rag/workbench.py`

## Commands

```powershell
python -m pytest curriculum/04-module-4-agentic-workflows/week-02-advanced-rag --collect-only -q
python -m pytest curriculum/04-module-4-agentic-workflows/week-02-advanced-rag -q
```

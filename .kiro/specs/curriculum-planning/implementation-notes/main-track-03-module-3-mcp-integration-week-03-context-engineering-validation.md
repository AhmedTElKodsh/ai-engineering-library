...
Scaffold: `curriculum/main-track/03-module-3-mcp-integration/week-03-context-engineering/workbench.py`

## Commands

```powershell
python -m pytest curriculum/main-track/03-module-3-mcp-integration/week-03-context-engineering --collect-only -q
python -m pytest curriculum/main-track/03-module-3-mcp-integration/week-03-context-engineering -q
```

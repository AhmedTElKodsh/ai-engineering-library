...
```powershell
python -m pytest curriculum/04-module-4-agentic-workflows/week-01-basic-rag --collect-only -q
python -m pytest curriculum/04-module-4-agentic-workflows/week-01-basic-rag -q
```

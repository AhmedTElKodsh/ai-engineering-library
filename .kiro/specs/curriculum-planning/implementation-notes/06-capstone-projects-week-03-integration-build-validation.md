...
```powershell
python -m pytest curriculum/06-capstone-projects/week-03-integration-build --collect-only -q
python -m pytest curriculum/06-capstone-projects/week-03-integration-build -q
```

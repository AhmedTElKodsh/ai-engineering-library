...
Scaffold: `curriculum/04-module-4-agentic-workflows/week-03-core-patterns/workbench.py`

## Commands

```powershell
python -m pytest curriculum/04-module-4-agentic-workflows/week-03-core-patterns --collect-only -q
python -m pytest curriculum/04-module-4-agentic-workflows/week-03-core-patterns -q
```

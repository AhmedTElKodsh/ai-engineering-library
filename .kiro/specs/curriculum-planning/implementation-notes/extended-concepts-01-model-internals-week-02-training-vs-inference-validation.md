...
Scaffold: `curriculum/extended-concepts/01-model-internals/week-02-training-vs-inference/workbench.py`

## Commands

```powershell
python -m pytest curriculum/extended-concepts/01-model-internals/week-02-training-vs-inference --collect-only -q
python -m pytest curriculum/extended-concepts/01-model-internals/week-02-training-vs-inference -q
```

...
Scaffold: `curriculum/02-module-2-first-principles/week-03-attention/workbench.py`

## Commands

```powershell
python -m pytest curriculum/02-module-2-first-principles/week-03-attention --collect-only -q
python -m pytest curriculum/02-module-2-first-principles/week-03-attention -q
```

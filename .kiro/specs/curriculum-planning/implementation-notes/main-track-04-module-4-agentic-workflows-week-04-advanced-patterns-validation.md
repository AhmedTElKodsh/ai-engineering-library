...
```powershell
python -m pytest curriculum/main-track/04-module-4-agentic-workflows/week-04-advanced-patterns --collect-only -q
python -m pytest curriculum/main-track/04-module-4-agentic-workflows/week-04-advanced-patterns -q
```

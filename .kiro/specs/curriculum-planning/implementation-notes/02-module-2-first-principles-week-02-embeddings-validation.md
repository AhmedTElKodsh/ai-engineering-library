...
Scaffold: `curriculum/02-module-2-first-principles/week-02-embeddings/workbench.py`

## Commands

```powershell
python -m pytest curriculum/02-module-2-first-principles/week-02-embeddings --collect-only -q
python -m pytest curriculum/02-module-2-first-principles/week-02-embeddings -q
```

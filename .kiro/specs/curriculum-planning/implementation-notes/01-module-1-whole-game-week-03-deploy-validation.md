...
Scaffold: `curriculum/01-module-1-whole-game/week-03-deploy/workbench.py`

## Commands

```powershell
python -m pytest curriculum/01-module-1-whole-game/week-03-deploy --collect-only -q
python -m pytest curriculum/01-module-1-whole-game/week-03-deploy -q
```

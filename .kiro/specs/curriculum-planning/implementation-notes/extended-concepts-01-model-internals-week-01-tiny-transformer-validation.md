...
Scaffold: `curriculum/extended-concepts/01-model-internals/week-01-tiny-transformer/workbench.py`

## Commands

```powershell
python -m pytest curriculum/extended-concepts/01-model-internals/week-01-tiny-transformer --collect-only -q
python -m pytest curriculum/extended-concepts/01-model-internals/week-01-tiny-transformer -q
```

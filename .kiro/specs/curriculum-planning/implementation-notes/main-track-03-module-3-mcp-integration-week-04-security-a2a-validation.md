...
Scaffold: `curriculum/main-track/03-module-3-mcp-integration/week-04-security-a2a/workbench.py`

## Commands

```powershell
python -m pytest curriculum/main-track/03-module-3-mcp-integration/week-04-security-a2a --collect-only -q
python -m pytest curriculum/main-track/03-module-3-mcp-integration/week-04-security-a2a -q
```

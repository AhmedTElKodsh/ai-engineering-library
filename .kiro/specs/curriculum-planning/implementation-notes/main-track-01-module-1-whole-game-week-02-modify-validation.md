...
```powershell
python -m pytest curriculum/main-track/01-module-1-whole-game/week-02-modify --collect-only -q
python -m pytest curriculum/main-track/01-module-1-whole-game/week-02-modify -q
```

...
```powershell
python -m pytest curriculum/extended-concepts/02-agentic-systems/week-03-multi-role-collaboration --collect-only -q
python -m pytest curriculum/extended-concepts/02-agentic-systems/week-03-multi-role-collaboration -q
```

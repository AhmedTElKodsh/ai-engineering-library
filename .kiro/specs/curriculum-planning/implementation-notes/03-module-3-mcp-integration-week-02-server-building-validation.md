...
```powershell
python -m pytest curriculum/03-module-3-mcp-integration/week-02-server-building --collect-only -q
python -m pytest curriculum/03-module-3-mcp-integration/week-02-server-building -q
```

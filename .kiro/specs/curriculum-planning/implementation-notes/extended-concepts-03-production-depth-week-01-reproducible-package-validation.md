...
Scaffold: `curriculum/extended-concepts/03-production-depth/week-01-reproducible-package/workbench.py`

## Commands

```powershell
python -m pytest curriculum/extended-concepts/03-production-depth/week-01-reproducible-package --collect-only -q
python -m pytest curriculum/extended-concepts/03-production-depth/week-01-reproducible-package -q
```

...
Scaffold: `curriculum/extended-concepts/02-agentic-systems/week-01-framework-state-machine/workbench.py`

## Commands

```powershell
python -m pytest curriculum/extended-concepts/02-agentic-systems/week-01-framework-state-machine --collect-only -q
python -m pytest curriculum/extended-concepts/02-agentic-systems/week-01-framework-state-machine -q
```

...
- all tests pass
- context selection preserves source IDs and reports dropped context
- decoding choices are deterministic and explainable
- the model-strategy decision compares deterministic code, RAG, and larger context

...
| --- | --- | --- | --- |
| Contract correctness | Implements the required behavior for draft quality, critique rules, retry limits, and human-review escalation with deterministic, reviewable outputs | Required tests pass for the core behavior | Outputs are incomplete, ad hoc, or depend on hidden assumptions |
...
| FinAgent transfer | Explains how the work strengthens FinAgent or a practical AI system: FinAgent can improve drafts without hiding repeated failures or bypassing human review | Gives a plausible transfer note | Cannot connect the lesson to a real system outcome |

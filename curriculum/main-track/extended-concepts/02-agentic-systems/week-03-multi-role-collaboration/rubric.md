# Rubric: Multi-Role Review Workflow

| Criterion | Excellent | Passing | Needs Work |
| --- | --- | --- | --- |
| Contract correctness | Implements the required behavior for role selection, minimal handoff context, review severity, and outcome rules with deterministic, reviewable outputs | Required tests pass for the core behavior | Outputs are incomplete, ad hoc, or depend on hidden assumptions |
...
| FinAgent transfer | Explains how the work strengthens FinAgent or a practical AI system: FinAgent can use focused review roles without over-sharing context or losing ownership | Gives a plausible transfer note | Cannot connect the lesson to a real system outcome |

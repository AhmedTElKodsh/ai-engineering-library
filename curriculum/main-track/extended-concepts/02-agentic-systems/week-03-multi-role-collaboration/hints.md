...
Name the contract before editing code. For this lesson, focus on role selection, minimal handoff context, review severity, and outcome rules.
...
- transfer evidence: FinAgent can use focused review roles without over-sharing context or losing ownership

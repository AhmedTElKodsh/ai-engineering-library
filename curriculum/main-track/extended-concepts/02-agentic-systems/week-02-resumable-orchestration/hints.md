...
Name the contract before editing code. For this lesson, focus on checkpointed steps, retry limits, error recording, and resume decisions.
...
- transfer evidence: FinAgent can recover from interrupted or failed workflows without looping forever

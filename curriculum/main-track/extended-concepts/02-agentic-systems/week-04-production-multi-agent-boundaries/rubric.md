# Rubric: Production Multi-Agent Boundaries

| Criterion | Excellent | Passing | Needs Work |
| --- | --- | --- | --- |
| Contract correctness | Implements the required behavior for authorization, tool policy, maximum steps, stop reasons, and run reports with deterministic, reviewable outputs | Required tests pass for the core behavior | Outputs are incomplete, ad hoc, or depend on hidden assumptions |
...
| FinAgent transfer | Explains how the work strengthens FinAgent or a practical AI system: FinAgent experiments stay auditable, bounded, and safe enough to review | Gives a plausible transfer note | Cannot connect the lesson to a real system outcome |

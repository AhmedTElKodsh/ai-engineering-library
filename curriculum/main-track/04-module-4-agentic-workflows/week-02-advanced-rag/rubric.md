...
| --- | --- | --- | --- |
| Retrieval | Ranks chunks with explainable scores | Finds relevant chunks | Returns arbitrary chunks |
| Citations | Every answer claim maps to chunk metadata | Includes citation IDs | Missing or weak citations |
| Abstention | Refuses unsupported questions clearly | Has a basic no-evidence path | Guesses without evidence |
| Transfer | Consumes web-acquisition and Phase 1 outputs | Uses chunk-like inputs | Ignores provenance |

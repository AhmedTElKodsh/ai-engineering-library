...
Module 4 combines AI-ready data, retrieval, source grounding, and controlled workflows. Framework-managed state, resumable orchestration, multi-role collaboration, and production multi-agent boundaries now live in Extended Concepts for learners who are ahead or returning later.
...
- `../../extended-concepts/02-agentic-systems/week-01-framework-state-machine/`: Framework State Machine Lab
- `../../extended-concepts/02-agentic-systems/week-02-resumable-orchestration/`: Resumable Orchestration Lab
- `../../extended-concepts/02-agentic-systems/week-03-multi-role-collaboration/`: Multi-Role Review Workflow Lab
- `../../extended-concepts/02-agentic-systems/week-04-production-multi-agent-boundaries/`: Production Multi-Agent Boundaries Lab

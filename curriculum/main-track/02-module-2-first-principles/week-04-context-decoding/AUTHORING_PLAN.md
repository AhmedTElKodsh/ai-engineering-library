# Authoring Plan: Module 2 Phase 4

## Scope

Create a context window and decoding lab after attention and before Module 3
provider, prompt, and tool boundaries.
...
```powershell
python -m pytest curriculum/main-track/02-module-2-first-principles/week-04-context-decoding/tests -v
```
...
- Current capability the learner brings into this lesson: tokenization,
  embeddings, attention, and inspectable trace notes.

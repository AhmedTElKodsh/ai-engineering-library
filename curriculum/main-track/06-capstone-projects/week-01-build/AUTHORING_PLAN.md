...
- Stable folder: `curriculum/main-track/06-capstone-projects/week-01-build`
...
```powershell
python -m pytest --collect-only curriculum/main-track/06-capstone-projects/week-01-build/tests -q
```

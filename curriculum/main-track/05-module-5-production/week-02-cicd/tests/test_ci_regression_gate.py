...
def test_build_ci_command_checklist_is_rerunnable_from_repo_root():
    checklist = build_ci_command_checklist(
        ["curriculum/main-track/05-module-5-production/week-01-golden-datasets/tests"],
    ...
    assert checklist == [
        ...
        "python scripts/run_golden_eval.py --fixture week-02-cicd/fixtures/eval-run-passing.json",
        "python -m pytest curriculum/main-track/05-module-5-production/week-02-cicd/tests -v",
    ]
...
def test_build_gate_report_contains_versions_failures_and_commands():
    ...
    assert report["checklist"][-1] == "python -m pytest curriculum/main-track/05-module-5-production/week-02-cicd/tests -v"

...
This file is an authoring aid. It keeps Milestone 1 production work concrete: a learner should produce evidence a teammate can rerun, inspect, and use to make a release decision.
...
| B10 `LLM Engineer's Handbook` | Chapter 7, p.291 and p.300-303, `B10_B10_P0291_C001`, `B10_B10_P0300_C001`, `B10_B10_P0302_C001`, `B10_B10_P0303_C001` | LLM and RAG evaluation should compare behavior with fit-for-task metrics; judge-based evals need caution and monitoring. | Keep Milestone 1 evals deterministic first, then label optional judge-based checks as advanced. |
...
| Local PDF `LLMOps` | p.211, p.218, p.224, p.229, and p.251-253 | Governance, privacy, security, audit artifacts, risk review, and restore planning are production concerns, but Milestone 1 should keep them as inspectable notes and checks. | Require redaction/audit notes and optional restore/runbook notes; defer enterprise governance platforms and infrastructure depth to Milestone 3. |
...
- Defer full LLMOps platforms, governance programs, drift/retraining systems, and enterprise monitoring stacks to Milestone 3.

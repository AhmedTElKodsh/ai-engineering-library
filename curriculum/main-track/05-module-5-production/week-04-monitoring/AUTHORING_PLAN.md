...
```powershell
python -m pytest curriculum/main-track/05-module-5-production/week-04-monitoring/tests -v
```
...
- Current capability the learner brings into this lesson: golden evals, release-gate decisions, and local service boundaries.

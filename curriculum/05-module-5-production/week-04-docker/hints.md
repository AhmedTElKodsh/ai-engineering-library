...
Name the contract before editing code. For this lesson, focus on run metadata, required environment, artifact paths, Dockerfile notes, and clean-checkout commands.
...
- transfer evidence: FinAgent can be reviewed and rerun by another engineer from clear evidence

# Authoring Plan: Module 5 Week 6

## Scope

Create a cost, latency, caching, batching, and retry tradeoff lab after
monitoring and before model adaptation decisions.
...
```powershell
python -m pytest curriculum/05-module-5-production/week-06-optimization/tests -v
```

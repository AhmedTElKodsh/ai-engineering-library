# Rubric: Model Adaptation Decision

| Criterion | Excellent | Passing | Needs Work |
| --- | --- | --- | --- |
| Contract correctness | Implements the required behavior for deterministic code, prompting, structured outputs, RAG, tools, agents, and fine-tuning tradeoffs with deterministic, reviewable outputs | Required tests pass for the core behavior | Outputs are incomplete, ad hoc, or depend on hidden assumptions |
...
| FinAgent transfer | Explains how the work strengthens FinAgent or a practical AI system: FinAgent avoids premature fine-tuning and chooses the smallest reliable adaptation | Gives a plausible transfer note | Cannot connect the lesson to a real system outcome |

...
Name the contract before editing code. For this lesson, focus on deterministic code, prompting, structured outputs, RAG, tools, agents, and fine-tuning tradeoffs.
...
- transfer evidence: FinAgent avoids premature fine-tuning and chooses the smallest reliable adaptation

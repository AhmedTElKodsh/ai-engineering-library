...
Name the contract before editing code. For this lesson, focus on immutable state, explicit transitions, completed steps, and current position.
...
- transfer evidence: FinAgent can move toward framework orchestration only after the state is inspectable

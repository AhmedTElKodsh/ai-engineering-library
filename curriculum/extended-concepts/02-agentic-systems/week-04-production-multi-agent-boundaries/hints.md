...
Name the contract before editing code. For this lesson, focus on authorization, tool policy, maximum steps, stop reasons, and run reports.
...
- transfer evidence: FinAgent experiments stay auditable, bounded, and safe enough to review
